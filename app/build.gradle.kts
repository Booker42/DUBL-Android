...
val appVersionName = providers.environmentVariable("DUBL_VERSION_NAME").orNull ?: "0.3.1"
val appVersionCode = providers.environmentVariable("DUBL_VERSION_CODE").orNull?.toIntOrNull() ?: 3001
