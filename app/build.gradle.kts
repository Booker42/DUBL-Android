...
val appVersionName = providers.environmentVariable("DUBL_VERSION_NAME").orNull ?: "0.1.3"
val appVersionCode = providers.environmentVariable("DUBL_VERSION_CODE").orNull?.toIntOrNull() ?: 1003
