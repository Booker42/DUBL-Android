...
val appVersionName = providers.environmentVariable("DUBL_VERSION_NAME").orNull ?: "0.5.1"
val appVersionCode = providers.environmentVariable("DUBL_VERSION_CODE").orNull?.toIntOrNull() ?: 5001000
